...
chut_inicial = [14.45, 3.37,] # chute inicial do ajuste com scipy
...
resultado_ajuste = novo_ajuste.fit(y1, r=x1, epsilon=14.45, sigma=3.37)
...
d = open('info_ajuste_CEP_He.txt', 'w')
d.write('--------------------------------------------------\n')
...
plt.savefig('ajuste_Ar_LJ.png', dpi=500, orientation='portrait', transparent=True, format='png')
plt.savefig('ajuste_Ar_LJ.pdf', dpi=500, orientation='portrait', transparent=True, format='pdf')
plt.show()
